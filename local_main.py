...
from Utils.train import seq2seq_train
...
parser.add_argument('--model-save-dir', type=str, default='./model_pkls/')
...
parser.add_argument('--model-type', type=str, default='cnn',
                    choices=('cnn', 'rnn', 'seq2seq'))
parser.add_argument('--model', type=str, default='NN',
                    choices=('NN', 'CNN', 'AlexNet', 'NiN', 'VGG',
                             'GoogLeNet', 'ResNet', 'SEResNet',
                             'MyRNN', 'RNN', 'BiRNN', 'ResidualRNN', 'BiResidualRNN',
                             'LSTM', 'BiLSTM', 'ResidualLSTM', 'BiResidualLSTM',
                             'GRU', 'BiGRU', 'ResidualGRU', 'BiResidualGRU',
                             'Transformer'))
